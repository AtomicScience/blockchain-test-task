...
function addContractToToken(token : Token, provider : Web3Provider) : void {
    ...
    token.contract = ERC20ContractBuilder(token.contractAddress)
}
...
tokens.forEach(addContractToToken)
